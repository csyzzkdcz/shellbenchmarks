...
set(SEARCH_PATHS
   /Users/chenzhen/mosek/8/tools/platform/osx64x86/
)
# Hardcoded search paths
#set(SEARCH_PATHS
#   /Users/chenzhen/mosek/8/tools/platform/osx64x86/
...
set(MOSEK_FUSION_LIBRARIES)
find_library(MOSEK_FUSION_LIBRARIES NAMES fusion64
  HINT
    "${MOSEK_INCLUDE_DIR}"
    "${MOSEK_INCLUDE_DIR}/bin"
    "${MOSEK_INCLUDE_DIR}/lib"
...
find_package_handle_standard_args(
  MOSEK DEFAULT_MSG MOSEK_LIBRARIES MOSEK_FUSION_LIBRARIES MOSEK_INCLUDE_DIR
)
set(MOSEK_INCLUDE_DIRS ${MOSEK_INCLUDE_DIR})

# Hide variables from CMake-Gui options
mark_as_advanced(MOSEK_LIBRARIES MOSEK_FUSION_LIBRARIES MOSEK_INCLUDE_DIRS MOSEK_INCLUDE_DIR)
